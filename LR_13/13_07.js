...
net.createServer(clientProcessing(serverPort1)).listen(serverPort1, serverHost).on('listening', () => {
    console.log('TCP-server listening on: ' + serverHost + ':' + serverPort1);
});
net.createServer(clientProcessing(serverPort2)).listen(serverPort2, serverHost).on('listening', () => {
    console.log('TCP-server listening on: ' + serverHost + ':' + serverPort2);
});